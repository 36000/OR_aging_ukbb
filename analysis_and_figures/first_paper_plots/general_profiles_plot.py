...
if "ukbb" in dataset:
    ...
    if "profs" in dataset:
        ...
        binning = "is_dis"
        if "right" in dataset:
            columns = ["fov", "mac", "periph", "CST_R", "UNC_R"]
            sides = ["R"]
        else:
            columns = ["fov", "mac", "periph", "CST_L", "UNC_L"]
            sides = ["L"]
        dataset = "profs"
    else:
        all_sides = True
        columns = ["fov", "mac", "periph", "CST", "UNC"]
        sides = ["L", "R"]
        dataset = "match"
else:
    all_sides = False
...
for scalar in tqdm(["fa", "md", "mk"]):
    ...
    for column in tqdm(columns, leave=False):
        ...
        if scalar == "fa":
            ...
            top_title = ""
        if column == "fov" or column == "LR_only" or column == "CST_L" or column == "UNC_L":
        ...
        if column in ["fov", "mac", "periph", "CST", "UNC", "LR_only", "CST_L", "CST_R", "UNC_L", "UNC_R"]:
            if "match" in dataset:
